---
title: "CAGE Oikopleura (clustering)"
...
plotAnnot_CTSS <- function(x, gff, up = 100, down = 100, ...) {
...
p_10 <- plotAnnot_CTSS(ce_SL[CTSScoordinatesGR(ce_SL)$CTSS_expr_range == "(0,10]", ] , gff) + ggtitle("(0,10]")
...
p3_sl <- plotReverseCumulatives(tcs) + theme_bw() + ggtitle("SL found", sub = "Tag clusters")
(p2_sl + scale_y_log10(limits=c(1,1e5)) + ggtitle("SL found", sub = "CTSS") |
